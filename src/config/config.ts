...
export const CLAIM_START_AT = new Date('2025-10-24T08:00:00+08:00').getTime() // 节点mint开始时间
export const CLAIM_END_AT = new Date('2025-10-26T08:00:00+08:00').getTime() // 节点mint结束时间
